...
extern std::wstring wxdec (int);
extern std::wstring wxdec (long);
extern std::wstring wxdec (OSMisc::longlong);
extern std::wstring wxdec (unsigned int);
extern std::wstring wxdec (unsigned long);
extern std::wstring wxdec (OSMisc::ulonglong);
