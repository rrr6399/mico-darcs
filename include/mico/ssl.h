...
#ifdef USE_SL3
    static void
    transp_creds(TransportSecurity::OwnCredentials_ptr creds)
    { S_transp_creds_ = TransportSecurity::OwnCredentials::_duplicate(creds); }
private:
    // it needs to be static to allow usage from static ::setup_ctx method
    static TransportSecurity::OwnCredentials_var S_transp_creds_;
#endif // USE_SL3
};
