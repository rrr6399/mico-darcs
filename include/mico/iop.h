...
#endif
#ifdef USE_SL3
    // kcg: we use CORBA::Object_var here to not need to use
    // forward declaration of various types from TransportSecurity namespace
    // The purpose of these variables is just to hold
    // transport security OwnCredentials, AcceptingContext and InitiatingContext
    // references as long as GIOP connection is alive.
    CORBA::Object_var init_ctx_;
    CORBA::Object_var accept_ctx_;
    CORBA::String_var creds_id_;
    CORBA::Object_var own_creds_;
#endif // USE_SL3
...
public:
    ...
    CORBA::Object_ptr
    initiating_context()
    { return CORBA::Object::_duplicate(init_ctx_); }

    void
    initiating_context(CORBA::Object_ptr ctx)
    { init_ctx_ = CORBA::Object::_duplicate(ctx); }

    CORBA::Object_ptr
    accepting_context()
    { return CORBA::Object::_duplicate(accept_ctx_); }

    void
    accepting_context(CORBA::Object_ptr ctx)
    { accept_ctx_ = CORBA::Object::_duplicate(ctx); }
    ...
    CORBA::Object_ptr
    own_creds()
    { return CORBA::Object::_duplicate(own_creds_); }

    void
    own_creds(CORBA::Object_ptr creds)
    { own_creds_ = CORBA::Object::_duplicate(creds); }
#endif // USE_SL3
};
